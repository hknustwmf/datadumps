...
final class btree
{
    ...
    public function range($startkey, $endkey)
    {
        ...
        while (!empty($start)) {
            ...
            $upnodes = $nodes;mwscript $(pwd)/dumpwatchlist2.php --wiki=wikidatawiki
			Dumping watchlist records..................................................................................................................................................
			Processed 13980672 watchlist records.
			Running 'sort -o /tmp/sorted.tsv /tmp/output.tsv'...
			Aggregating...........................................................................................................................................
			Aggregated 13980672 rows. 13980672 (100%) non-existing titles found.
			Done! Finished in 203.08 seconds.
        }
    ...
    public function set($key, $value)
    {
        ...
        // traverse tree up
        do {mwscript $(pwd)/dumpwatchlist2.php --wiki=wikidatawiki
			Dumping watchlist records..................................................................................................................................................
			Processed 13980672 watchlist records.
			Running 'sort -o /tmp/sorted.tsv /tmp/output.tsv'...
			Aggregating...........................................................................................................................................
